...
class ServerTest {
    ...
    @Test
    fun `tasks can be found by priority`() =
        testApplication {
            configure()
    ...
    @Test
    fun `invalid priority produces 400`() =
        testApplication {
            configure()
    ...
    @Test
    fun `unused priority produces 404`() =
        testApplication {
            configure()
